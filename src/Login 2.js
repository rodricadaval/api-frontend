        ...
        axios.post('api/login', this.state.user)
            ...
            .catch(
                error => { 
                    ...
                    alert("Usuario y/o Contreseña incorrecta");
                }
            );
    }
                            ...
                            <div class="wrap-login100">
                                <form class="login100-form validate-form" onSubmit={this.handleSubmit}>
                                    ...
                                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                                        <input class="input100" id="password" name="password" value={this.state.user.password} type="password" onChange={this.updateState.bind(this, 'password')} placeholder="Contraseña" />
                                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                                    </div>
